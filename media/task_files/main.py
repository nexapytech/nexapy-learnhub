...
class Venybot:
    ...
    def __init__(
        ...
        print(Fore.LIGHTMAGENTA_EX + "Venybot v" + VERSION + Style.RESET_ALL)
        print(Fore.WHITE + "Run with --help for command line options" + Style.RESET_ALL)
        print(
            Fore.LIGHTYELLOW_EX
            + "Welcome to Venybot, the best rocket league auto play bot there is."
            + Style.RESET_ALL
        )
        ...
        try:
            ...
            print(
                Fore.RED
                + "No config.json found, writing default config, dont delete it please."
                + Style.RESET_ALL
            )
    ...
    def start(self):
        ...
        try:
            ...
            print(Fore.RED + "Failed to start bot: ", e, Style.RESET_ALL)
            exit()
        ...
        print(Fore.LIGHTGREEN_EX + "bot started" + Style.RESET_ALL)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Venybot")
